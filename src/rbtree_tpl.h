...
#define LINK_RBTREENODE_STRING_RETURNDUPLICATE( _this_func_ , _struct_ENV_ , _p_env_member_rbtree_ , _struct_UNIT_ , _p_unit_member_rbnode_ , _p_unit_member_str_ ) \
	_struct_UNIT_ *_this_func_( _struct_ENV_ *_p_env , _struct_UNIT_ *_p_unit ) \
	{ \
		struct rb_node		**_pp_add_node = NULL ;	\
		struct rb_node		*_p_parent = NULL ; \
...
#define QUERY_RBTREENODE_INT( _this_func_ , _struct_ENV_ , _p_env_member_rbtree_ , _struct_UNIT_ , _p_unit_member_rbnode_ , _p_unit_member_int_ ) \
	_struct_UNIT_ *_this_func_( _struct_ENV_ *_p_env , _struct_UNIT_ *_p_unit ) \
	{ \
		struct rb_node		*_query_node = _p_env->_p_env_member_rbtree_.rb_node ; \
		_struct_UNIT_		*_p = NULL ; \
...
#define QUERY_RBTREENODE_INT_NOLESSTHAN( _this_func_ , _struct_ENV_ , _p_env_member_rbtree_ , _struct_UNIT_ , _p_unit_member_rbnode_ , _p_unit_member_int_ ) \
	_struct_UNIT_ *_this_func_( _struct_ENV_ *_p_env , _struct_UNIT_ *_p_unit ) \
	{ \
		struct rb_node		*_query_node = _p_env->_p_env_member_rbtree_.rb_node ; \
		_struct_UNIT_		*_p = NULL ; \
...
#define LINK_RBTREENODE_POINTER( _this_func_ , _struct_ENV_ , _p_env_member_rbtree_ , _struct_UNIT_ , _p_unit_member_rbnode_ , _p_unit_member_addr_ ) \
	int _this_func_( _struct_ENV_ *_p_env , _struct_UNIT_ *_p_unit ) \
	{ \
		struct rb_node		**_pp_add_node = NULL ;	\
		struct rb_node		*_p_parent = NULL ; \
		...
		{ \
			...
			_p_parent = (*_pp_add_node) ; \
			\
			_result = _p_unit->_p_unit_member_addr_ - _p->_p_unit_member_addr_ ; \
			if( _result < 0 ) \
				_pp_add_node = & ((*_pp_add_node)->rb_left) ; \
			else if( _result > 0 ) \
				_pp_add_node = & ((*_pp_add_node)->rb_right) ; \
...
#define QUERY_RBTREENODE_POINTER( _this_func_ , _struct_ENV_ , _p_env_member_rbtree_ , _struct_UNIT_ , _p_unit_member_rbnode_ , _p_unit_member_addr_ ) \
	_struct_UNIT_ *_this_func_( _struct_ENV_ *_p_env , _struct_UNIT_ *_p_unit ) \
	{ \
		struct rb_node		*_query_node = _p_env->_p_env_member_rbtree_.rb_node ; \
		_struct_UNIT_		*_p = NULL ; \

...
#define MAX_SMALL_MEMPOOL_BLOCK_SIZE_CLASS	16
#define MAX_SMALL_MEMPOOL_BLOCK_SIZE		(1<<MAX_SMALL_MEMPOOL_BLOCK_SIZE_CLASS) /* 低于等于此大小的内存块在线程全局池中管理 */

#define MAX_MEDIUM_MEMPOOL_BLOCK_SIZE_CLASS	26
#define MAX_MEDIUM_MEMPOOL_BLOCK_SIZE		(1<<MAX_MEDIUM_MEMPOOL_BLOCK_SIZE_CLASS) /* 低于等于此大小的内存块在进程全局池中管理 */

#define DIFF_PROCESS_MEMPOOL_BLOCK_SIZE_CLASS	(MAX_MEDIUM_MEMPOOL_BLOCK_SIZE_CLASS-MAX_SMALL_MEMPOOL_BLOCK_SIZE_CLASS)
